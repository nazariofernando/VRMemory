...
public class Example15 : Example4
{
    public SkinnedMeshRenderer Head = null;
    ...
    private List<string> m_blendShapes = new List<string>();

    private Dictionary<string, DateTime> m_detected = new Dictionary<string, DateTime>(); 
